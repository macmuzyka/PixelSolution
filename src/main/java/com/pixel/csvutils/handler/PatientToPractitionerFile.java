 ...
 */
@Component
public class PatientToPractitionerFile implements CSVTransformer {
    static String[] HEADERS = {"patientId", "practitionerId"};

    @Override
    public List<PatientToPractitioner> fromFileToRecordsList(final InputStream inputStream) {
