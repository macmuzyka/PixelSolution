...
@Component
public class PractitionerFile implements CSVTransformer {

    static String[] HEADERS = {"practitionerId", "specialization"};

    @Override
    public List<Practitioner> fromFileToRecordsList(final InputStream inputStream) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream, StandardCharsets.UTF_8));
            ...
            listPopulating(practitionersList,
                    records);
